...
import com.artfonapps.clientrestore.network.events.AcceptEvent;
import com.artfonapps.clientrestore.network.events.ClickEvent;
import com.artfonapps.clientrestore.network.events.LoadPointsEvent;
import com.artfonapps.clientrestore.network.events.LogEvent;
import com.artfonapps.clientrestore.network.events.LoginEvent;
import com.artfonapps.clientrestore.network.events.LogoutEvent;
import com.artfonapps.clientrestore.network.events.RejectEvent;
...
public class Communicator {
    ...
    public static String debugDomainName = "http://192.168.0.117:8080/";
